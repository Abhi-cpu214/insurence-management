...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            echo '<a href="logs.php"><i class="fa fa-pencil-square-o "></i>VIEW LOGS </a>';
			}
			?>   
            </li>
            <li><form action="client_by_policyid.php" method="get">
                  
                    <input class="form-control my-0 py-1" name="policyid" type="text" placeholder="Enter Policy ID" aria-label="ID">
